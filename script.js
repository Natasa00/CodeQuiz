...
choices.addEventListener("click", function (event) {
    ...
    if (chosenAns.matches("#start") === false) {
        ...
        if (
            ...
            questionResult.style.color = "rgb(0,0,139)";
        } else {
            clock = clock - 30;
...
document.getElementById("done").addEventListener("click", function (event) {
    ...
    if (userInitials === "") {
        ...
        document.getElementById("noscore").removeAttribute("hidden")
        document.getElementById("finalStage").setAttribute("hidden", "true");
...
document.getElementById("noscore").addEventListener("click", function (event) {
